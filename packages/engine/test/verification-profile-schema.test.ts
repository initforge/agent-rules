...
// Drop the remote `$schema` meta-schema reference — Ajv 8 ships its own
// draft-07 meta-schema and refuses to follow the URL on this host.
delete rawSchema['$schema'];
const validate = new Ajv({ allErrors: true, strict: false }).compile(rawSchema);
