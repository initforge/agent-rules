...
const M11_EVIDENCE: Record<string, M11Evidence> = {
  'M11-R11': { modules: ['packages/engine/src/plan-readiness.ts', 'packages/cli/src/commands/plan.ts'], tests: ['packages/engine/test/plan-lifecycle.test.ts'] },
  ...
  'M11-R26': { modules: ['packages/engine/src/adversarial-compiler.ts'], tests: ['packages/engine/test/adversarial-closure.test.ts'] },
  'M11-R27': { modules: ['packages/engine/src/claim-registry.ts'], tests: ['packages/engine/test/evidence-dag.test.ts'] },
  ...
  'M11-R35': { modules: ['packages/engine/src/terminal-gate.ts'], tests: ['packages/engine/test/terminal-gate.test.ts'] },
