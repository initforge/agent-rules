...
export async function validate(
  ...
  // 5. Required paths
  const required = [
    "guides/00-system-map.md", "guides/05-maturity.md", "integrations/registry.json",
    "projects/5fedu/AGENTS.md", "projects/5fedu/00-context-map.md", "projects/5fedu/decisions.md",
  ...
  if (await checkFile(graphBuilder)) {
    const r = await runPowershell(graphBuilder, [
      "-Root", root,
      "-OutputPath", path.join(root, "05-generated", "context-graph.json"),
    ], root);
