...
2. `.agents/rules/06-opus-emulation-contract.md`
3. `.agents/rules/01-agent-workflow-sop.md`
4. `.agents/rules/04-skills-and-5fedu.md`
5. `.agents/rules/antigravity-overlay.md`
6. `.agents/rules/02-code-quality-and-debt.md` · `03-context-and-tools.md` · `05-harness-mutation-gate.md`

Toàn bộ 10 file trong `.agents/rules/` đều `alwaysApply`.
