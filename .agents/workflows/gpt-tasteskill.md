# gpt-tasteskill Skill

1. Read the skill file in the project-local adapter at `.agents/skills/gpt-tasteskill/SKILL.md` or the master backup at `P:\agent-rules\antigravity\.agents\skills\gpt-tasteskill\SKILL.md`.
