...
1. Read the skill file in the project-local adapter at `.agents/skills/codex-research/SKILL.md` or the master backup at `P:\agent-rules\antigravity\.agents\skills\codex-research\SKILL.md`.
