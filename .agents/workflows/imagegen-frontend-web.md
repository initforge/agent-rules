# imagegen-frontend-web Skill

1. Read the skill file in the project-local adapter at `.agents/skills/imagegen-frontend-web/SKILL.md` or the master backup at `P:\agent-rules\antigravity\.agents\skills\imagegen-frontend-web\SKILL.md`.
