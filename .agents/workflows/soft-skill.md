...
1. Read the skill file in the project-local adapter at `.agents/skills/soft-skill/SKILL.md` or the master backup at `P:\agent-rules\antigravity\.agents\skills\soft-skill\SKILL.md`.
