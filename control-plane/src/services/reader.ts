...
export function readAll(): CanonicalData {
  return {
    ...
    platformCapability: readFile(resolve('guides/06-platform-capability.md')),
    runtimeModel: readFile(resolve('guides/01-runtime-model.md')),
    integrationsSync: readFile(resolve('guides/03-integrations-and-sync.md')),
  };
}
