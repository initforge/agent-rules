---
alwaysApply: false
description: Canonical ownership, promotion, sync, and mirror governance.
---
...
- **Sync canonical**: agent-rules is source of truth; reviewed inbound only. See 41-harness-maintainer.md for full sync models, inbound/outbound guards, and tombstones logic.
...
- **Rút gọn / rewrite depth** skill hoặc rule: bắt buộc **Benefit–Harm Gate** (`50-context-budget.md`) — lợi > hại rõ → PROCEED; mơ hồ hoặc mất sức mạnh → **DISCUSS_OWNER**; **cấm slim-for-budget**.
