...
- **Owner intent:** `docs-style`, `plan-and-handoff` (+refs), `profile` domain packs **được phép lớn** — cohesion/depth; cấm “fix bloat” size-only (`50-context-budget` §Intentional oversize).
