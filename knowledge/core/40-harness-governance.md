...
Reverse-sync guard: never copy installed runtime/admin/system skills back into `knowledge/capabilities`. External skills such as verifier/check-work, workflow routers and creator/scaffolding skills stay runtime-only unless the owner explicitly promotes their behavior into a small canonical rule or a renamed project-owned capability.
