...
`researcher` is the primary research layer for Codex and Grok CLI.

It keeps the operating model inside the harness and does not depend on external research-first helpers.

## When to trigger researcher
