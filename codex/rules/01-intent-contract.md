...
- `/5fedu-project` là để scaffold hoặc duy trì context project-local: `AGENTS.md`, `.agents/5fedu/*.md` và `.codex/5fedu/*.md`. Không tự nhảy sang implement feature nếu user chỉ yêu cầu setup/context.
