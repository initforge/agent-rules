...
Trước khi làm database/auth/bảng nhân viên/migration, bắt buộc đọc `.codex/5fedu/10-owner-feedback-lessons.md`.
...
Khi làm module, schema, seed/import dữ liệu vận tải, auth/nhân viên, hoặc đối chiếu yêu cầu với sheet, bắt buộc đọc `.codex/5fedu/11-current-sheets-source-map.md`.
...
- Trước khi làm trang chủ, module vận tải, list/detail/form/action, combobox hoặc trường tổng hợp tự tính, bắt buộc đọc `.codex/5fedu/12-owner-feedback-transport-ui.md`.
