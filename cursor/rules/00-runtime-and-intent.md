...
Bộ rule cốt lõi cho **Grok CLI + Composer 2.5**. Nạp qua `.grok/rules/`. **Opus-emulation:** cùng đầu ra Opus với Gemini (`06-opus-emulation-contract.md`). Xem `docs/08-opus-emulation-harness.md`.
...
- Không port rule nền khác vào `.cursor/` mà không adapt.
...
### Protected files (Cursor)

- `cursor/AGENTS.md`, `cursor/rules/*.md`
- `.cursor/rules/*.md`
- `.grok/skills/5fedu-project/`, `.grok/rules/04-skills-and-5fedu.md`
