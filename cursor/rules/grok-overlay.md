...
Áp khi chạy **Grok CLI** với model Composer 2.5 (vd `grok --model composer-2.5-fast`).
...
**Phụ** (chỉ khi bật `[compat.cursor] rules` — mặc định true):
...
Codex tham chiếu skill/script: `~/.codex`, `agent-rules/codex`.
