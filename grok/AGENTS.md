...
`00-runtime-and-intent` · `01-agent-workflow-sop` · `02-code-quality-and-debt` · `03-context-and-tools` · `04-skills-and-5fedu` · `05-harness-mutation-gate` · `06-opus-emulation-contract` · `platform-boundary` · `grok-overlay`
