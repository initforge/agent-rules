...
|---|---|
| Thiết lập/khởi tạo 5fedu | Sử dụng Skill `5fedu-project` (`skills/5fedu-project/SKILL.md`) |
| Nghiên cứu/đọc tài liệu mới | Sử dụng Skill `researcher` (`skills/researcher/SKILL.md`) |
