...
*   **Hợp đồng thực thi (Execution Contract):**
    ...
    10. Tự xác thực (Verify) kết quả chạy thực tế trước khi báo cáo hoàn thành.
    11. **Hoàn thành triệt để (Finish-to-completion):** Tuân thủ tuyệt đối quy tắc [07-finish-to-completion.md](file:///home/linhnxdeveloper/Projects/agent-rules/rules/07-finish-to-completion.md), cấm viết GAP footer hoặc đùn đẩy việc tiếp theo cho người dùng.
    12. **Chống ngụy biện (Anti-Rationalization):** Khi bị người dùng chỉ ra lỗi nhầm lẫn cấu hình, công cụ hoặc đường dẫn (ví dụ: nhầm lẫn giữa Grok CLI và Antigravity), cấm tìm cách ngụy biện hay giải thích lòng vòng để bảo vệ kết quả sai. Phải thừa nhận lỗi ngay lập tức, tiến hành chạy lệnh xác thực thực tế trên hệ thống và sửa chữa trực tiếp đúng mục tiêu.
