...
| context learning, sửa rule/skill/workflow, feedback lặp lại | `context-evolution-protocol` | `skills/context-evolution-protocol/SKILL.md` |
...
- Không auto-load `context-evolution-protocol` cho task code thường; chỉ kích hoạt khi có tín hiệu học/sửa context/rule/skill/workflow hoặc feedback lặp lại.
