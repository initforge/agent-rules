...
check('cleanup-lifecycle', /PURGE_ELIGIBLE/.test(read('packages/cli/src/cleanup/lifecycle.ts')) && /activeReference/.test(read('packages/cli/src/cleanup/lifecycle.ts')), 'cleanup has graph-safe dry-run and active-reference guard');
