...
| 4.2 | structural-map.yaml | create/adapt/reuse per component; nesting; routes; state; data; events |
| 4.3 | visual-contract.yaml | shell_must invariants; variable slot values; alignment; responsive |
| 4.4 | behavior-contract.yaml | behavior_must; states; motion; accessibility; interaction flows |
| 4.5 | architecture-adaptation.yaml | preserve; adapt; must_not_copy; target equivalents; accepted deviations |
| 4.6 | deviations.yaml | approved deviations per custom_deviation_contract |
