...
|---|---|---|
| `docs/guides/` | Tài liệu maintainer, bản đồ hệ thống | ổn định (người viết) |
...
| `profiles/5fedu/projects/` | Gói dự án mẫu | ổn định |
...
| `generated/` | Output build — không sửa tay | generated (máy tạo) |
| `.agent/` | Trace log, research notes, tombstones (gitignored) | tạm thời |

**Tích hợp** — xem [bảng đầy đủ](generated/references/integration-registry.md) cho cả 5 mục (bắt buộc/khuyến nghị/tùy chọn) kèm profile, trust, capabilities. Nguồn chuẩn: `integrations/registry.json`. Phải chạy lại sau khi sửa registry:
...
1. [Bản đồ hệ thống](docs/guides/00-system-map.md)
2. [Mô hình runtime](docs/guides/01-runtime-model.md)
3. [Ma trận năng lực nền tảng](docs/guides/06-platform-capability.md)
4. English overview: [README.md](README.md)
5. Dự án 5fedu: [profiles/5fedu/projects/AGENTS.md](profiles/5fedu/projects/AGENTS.md) (bật profile trước)

**Quy tắc:** Sửa canonical tại `rules/` và `skills/` — không sửa `generated/` hay mirror đã cài. Sync ngược qua `automation/07-import-reviewed-changes.ps1`.
