...
- the task modifies or audits `AGENTS.md`, `01-global/**`, `02-projects/**`, `03-platforms/**`, `04-automation/**`, `.agents/**`, `.codex/**`, project context, or runtime harness files;
...
| `global-agent-rule` | Applies across projects/platforms | `01-global/rules/**` or a shared capability |
| `raw-evidence` | Chat/log/example kept for traceability | archive/backlog, not default load |
| `question` | Missing owner/spec decision | `00-map/open-questions.md` or decision backlog |
