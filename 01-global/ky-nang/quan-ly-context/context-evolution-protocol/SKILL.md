...
- the task modifies or audits `AGENTS.md`, `01-global/**`, `02-du-an/**`, `03-nen-tang/**`, `04-tu-dong-hoa/**`, `.agents/**`, `.codex/**`, project context, or runtime harness files;
...
| `global-agent-rule` | Applies across projects/platforms | `01-global/loi/**` or a shared capability |
| `raw-evidence` | Chat/log/example kept for traceability | archive/backlog, not default load |
| `question` | Missing owner/spec decision | `00-ban-do/cau-hoi-mo.md` or decision backlog |
