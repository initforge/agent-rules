...
- `01-global/rules/`: platform-neutral always-loaded behavior.
- `01-global/skills/`: lazy procedures grouped by subsystem.
- `02-projects/`: project context and templates.
- `01-global/integrations/`: external tools, manifests, adapters and policy.
- `03-platforms/<name>/`: only platform delta.
- `04-automation/`: build/install/validation/sync guards.
...
Reverse-sync guard: never copy installed runtime/admin/system skills back into `01-global/skills`. External/runtime-only skills stay outside canonical source unless the owner explicitly promotes their behavior into a small canonical rule or renamed project-owned capability.
