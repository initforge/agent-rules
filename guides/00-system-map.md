...
4. `guides/06-platform-capability.md` — capability matrix (explicit depth/status per platform).
...
| Generated reference | capability matrix, install paths, command reference, skill/rule index, integration registry, profile/schema index, deprecation list | machine (`05-generated/references/`) | Yes — run `python automation/generate-doc-references.py` |

**Rule:** Stable docs never duplicate volatile data from generated references. If you need integration details, link to `05-generated/references/integration-registry.md`, not a manually-maintained table.
...
### Generated output (`05-generated/`, `generated/`)

| Folder | Editable by hand | Regeneration | Description |
|---|---|---|---|
| `05-generated/` | Never | `01-build-runtime.ps1` | Build output, runtime mirrors, reference docs |
| `generated/` | Never | automation scripts | Machine-generated context (e.g., context graphs) |
...
Full list: [05-generated/references/deprecation-list.md](../05-generated/references/deprecation-list.md).  
