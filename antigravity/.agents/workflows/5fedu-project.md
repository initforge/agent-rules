...
3. Kiểm tra Repo hiện tại để xác định chế độ xử lý:
   - **Chưa có Context (New Project Setup)**: Chạy script `C:\Users\DELL\.codex\skills\5fedu-project\scripts\install-5fedu-context.ps1` để tạo cấu trúc mẫu. Thực hiện thích ứng (Adapt) cấu trúc và thuật ngữ phù hợp với loại hình dự án (ví dụ: app vận tải, webshop, ERP).
...
4. Load `C:\Users\DELL\.codex\skills\5fedu-project\references\5fedu-context-map.md` trước khi viết hoặc cập nhật các quy tắc nghiệp vụ dự án.
