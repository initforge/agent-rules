...
| Template `tahdieuphoi-ctrl/TAH_app` | `00`, `01`, `06`, `07`, `08`, `questions.md` | Đã chốt và đã clone source local | Source: `P:\tah-app-5f\.codex\template-source\TAH_app`; chỉnh sửa thì báo |
...
| --- | --- | --- | --- |
| Template giao diện commit `47947e6eea0b1b7dc6723356f37f604e30ac690b` | `00`, `06`, `12` | Đã phủ | Template local ở `.codex/template-source/TAH_app` |
