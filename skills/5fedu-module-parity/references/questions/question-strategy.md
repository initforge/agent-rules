...
| Q5 | "Deviation scope nào được phép?" | Custom behavior không có trong inventory | Mỗi deviation là object keyed by deviation ID trong `deviations.yaml.deviations`; phải ghi rõ `affected_surface`, `changed_invariant`, `rationale`, `unchanged_invariants`, `proof` |
