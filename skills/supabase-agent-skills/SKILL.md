...
- Security scan: .agent/evidence/skill-mcp-fabric-v1/provenance-scans/supabase-agent-skills — see .agent/evidence/skill-mcp-fabric-v1/provenance-scans/ (0 ELF binaries)
...
## Rollback
- Remove skills/supabase-agent-skills/ and revert candidate-fabric/catalog entries to the
