...
- the task modifies or audits `AGENTS.md`, `.agents/**`, `.codex/**`, `rules/**`, `skills/**`, `workflows/**`, project context `.md`, or runtime harness files;
...
| `global-agent-rule` | Applies across projects/platforms | `rules/**` or shared skill |
