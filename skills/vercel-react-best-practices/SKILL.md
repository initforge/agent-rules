...
- Security scan: .agent/evidence/skill-mcp-fabric-v1/provenance-scans/vercel-react-best-practices — see .agent/evidence/skill-mcp-fabric-v1/provenance-scans/ (0 ELF binaries)
...
## Use when
- Deterministic facts: react best practices; react performance guidance; react component rules.
...
## Rollback
- Remove skills/vercel-react-best-practices/ and revert candidate-fabric/catalog entries to the
