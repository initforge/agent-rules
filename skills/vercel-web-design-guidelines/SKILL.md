...
- License: unresolved (no LICENSE file in pinned tree (root or skill level))
- Security scan: .agent/evidence/skill-mcp-fabric-v1/provenance-scans/vercel-web-design-guidelines — see .agent/evidence/skill-mcp-fabric-v1/provenance-scans/ (0 ELF binaries)
...
## Use when
- Deterministic facts: web design guidelines; accessibility audit guidance; web performance audit.
...
## Rollback
- Remove skills/vercel-web-design-guidelines/ and revert candidate-fabric/catalog entries to the
