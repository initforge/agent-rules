...
$Template = Join-Path $RepoRoot "02-du-an\5fedu"
...
$Pointer = "# Project context pointer`n`nCanonical context: ``context/5fedu/AGENTS.md``. Read that entry file first, then follow the map inside ``00-ban-do/doc-truoc.md``.`n"
